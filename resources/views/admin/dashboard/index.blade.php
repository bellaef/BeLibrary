...
<div class="container-fluid">
    ...
    <div class="row mt-2">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header" style="background-color: #F8F4E1">Total Admin</div>
                <div class="card-body">{{ $jumlahAdmin }}</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-header" style="background-color: #F8F4E1">Total Pengunjung</div>
                <div class="card-body">{{ $jumlahPengunjung }}</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-header" style="background-color: #F8F4E1">Total Buku</div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header" style="background-color: #F8F4E1">Total Buku Terpinjam</div>
